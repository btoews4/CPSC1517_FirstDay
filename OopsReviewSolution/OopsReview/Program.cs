...
namespace OopsReview
{
    class Program
    {
                        ...
                        case "A":
                            {
                                ...
                                theTurn = new Turn();
                                theTurn.Player1Result = player1.Face;
                                theTurn.Player2Result = player2.Face;
        ...
        public static void DisplayCurrentPlayerStats(List<Turn> rounds)
        {
            ...
            {
                if (item.Player1Result > item.Player2Result)
                {
                    wins1++;
                }
                else
